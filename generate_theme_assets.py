#!/usr/bin/env python3
"""G2O Theme Asset Generator - No text in images"""
...
def create_aero_button(width, height, color, name, dpi="xhdpi"):
    """Windows 7 Aero glossy button - NO TEXT"""
...
def create_skeu_button(width, height, color, name, dpi="xhdpi"):
    """iOS 6 skeumorphic button - NO TEXT"""
    img = Image.new('RGBA', (width, height), (0, 0, 0, 0))
    draw = ImageDraw.Draw(img)
...
def create_material_button(width, height, color, name, dpi="xhdpi"):
    """Material Design flat button - NO TEXT"""
    img = Image.new('RGBA', (width, height), (0, 0, 0, 0))
    draw = ImageDraw.Draw(img)
...
print("✅ All assets generated (no text in images)!")
